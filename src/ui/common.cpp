...
namespace ui {
    ...
    const int MIN_TERMINAL_HEIGHT = ARENA_HEIGHT + 5;

    ftxui::ScreenInteractive appScreen = ftxui::ScreenInteractive::FixedSize(MIN_TERMINAL_WIDTH, MIN_TERMINAL_HEIGHT);
